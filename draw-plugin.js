...
(function() {
    Draw.loadPlugin(function(ui) {
        ...
        try {
            ...
            if (menu) {
                menu.addItem(ui, 'Create Document from Template', null, 'customDocumentCreator');
            }
        } catch (e) {
        ...
        console.log('Draw.io plugin loaded successfully!');
    });
})();
